...
class yourpersonal extends StatelessWidget {
  const yourpersonal({super.key});
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Center(
                            child: Text(
                              'Get your weekly fasting plan,daily \ncoaching and healthy challages',
                              style: GoogleFonts.adventPro(
                                  textStyle:
                                      Theme.of(context).textTheme.displayMedium,
                                  fontSize: 18,
