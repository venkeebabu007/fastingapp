...
class scientificallyprov extends StatelessWidget {
  const scientificallyprov({super.key});
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Center(
                            child: Text(
                              'Fasting is natural.No calorie Counting, \nno yo-yo effect.Enjoy food again',
                              style: GoogleFonts.adventPro(
                                  textStyle:
                                      Theme.of(context).textTheme.displayMedium,
                                  fontSize: 18,
