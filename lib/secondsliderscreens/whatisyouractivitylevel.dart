import 'package:fastingapp/secondsliderscreens/whatisyouractivityleveltwo.dart';
...
class whatisyouractivitylevel extends StatelessWidget {
  const whatisyouractivitylevel({super.key});
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        Get.to(whatisyouractivityleveltwo());
                      },
                      child: Padding(
                        padding:
