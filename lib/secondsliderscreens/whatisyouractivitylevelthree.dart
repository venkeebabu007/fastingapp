import 'package:fastingapp/secondsliderscreens/whatisyouractivitylevelfour.dart';
...
class whatisyouractivitylevelthree extends StatelessWidget {
  const whatisyouractivitylevelthree({super.key});
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        Get.to(whatisyouractivitylevelfour());
                      },
                      child: Padding(
                        padding:
